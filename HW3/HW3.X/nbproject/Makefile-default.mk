...
SOURCEFILES_QUOTED_IF_SPACED=mainHW3.c i2c_master_noint.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/mainHW3.o ${OBJECTDIR}/i2c_master_noint.o
POSSIBLE_DEPFILES=${OBJECTDIR}/mainHW3.o.d ${OBJECTDIR}/i2c_master_noint.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/mainHW3.o ${OBJECTDIR}/i2c_master_noint.o

# Source Files
SOURCEFILES=mainHW3.c i2c_master_noint.c
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/mainHW3.o: mainHW3.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/mainHW3.o.d 
	@${RM} ${OBJECTDIR}/mainHW3.o 
	@${FIXDEPS} "${OBJECTDIR}/mainHW3.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG   -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/mainHW3.o.d" -o ${OBJECTDIR}/mainHW3.o mainHW3.c    -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)  -mdfp=${DFP_DIR}  
...
${OBJECTDIR}/mainHW3.o: mainHW3.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/mainHW3.o.d 
	@${RM} ${OBJECTDIR}/mainHW3.o 
	@${FIXDEPS} "${OBJECTDIR}/mainHW3.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/mainHW3.o.d" -o ${OBJECTDIR}/mainHW3.o mainHW3.c    -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)  -mdfp=${DFP_DIR}  
